...
* produces Table A2 and Table A4 in Online Appendix
...
global fxlsout "$dir/tables/canada_lp_rob1.xlsx"
************************************************************
*
* housekeeping
local p $p
...
*set of controls (incl. time trends)
bys prov (year): g t = _n
g t2 = t^2
global ctrl1 "L(`q'/`lplags').dpolicyrate L(`q'/`lplags').dlgdp i.year"
global ctrl2 "L(`q'/`lplags').dpolicyrate L(`q'/`lplags').dlgdp t"
global ctrl3 "L(`q'/`lplags').dpolicyrate L(`q'/`lplags').dlgdp t2"
...
global q = 1 // recursiveness assumption
global fxlsout "$dir/tables/canada_var_rob.xlsx"
************************************************************
*
* housekeeping
local p $p
...
*set of controls
global ctrl1 "i.year"
global ctrl2 "L(`q'/`svlags').dlgdp i.year"
